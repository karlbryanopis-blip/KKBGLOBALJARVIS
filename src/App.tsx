                    ...
                    {[
                      {
                        ...
                        color: '#FF4F00',
                        bg: 'rgba(255,79,0,0.05)',
                        border: 'rgba(255,79,0,0.15)',
                        logoBg: '#ffffff',
                        icon: (
                          <img src="/download copy.png" alt="Zapier" className="w-full h-full object-contain p-1" />
                        ),
                      },
                      {
                        name: 'n8n',
                      ...
                      <div key={p.name} className="flex items-center gap-4 px-4 py-3 rounded-lg transition-all duration-200 hover:scale-[1.01]"
                        ...
                        <div className={`flex-shrink-0 ${p.name === 'Go High Level' || p.name === 'Zapier' ? 'w-20 h-10' : 'w-10 h-10'} rounded-lg flex items-center justify-center overflow-hidden`}
